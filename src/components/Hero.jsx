    ...
    <div className='relative flex w-full h-screen overflow-hidden'>
      ...
      <div className="relative z-10 flex justify-center items-center w-full">
        <div className="text-center p-6 rounded-lg max-w-4xl w-full">
          ...
          <h1 className="text-3xl md:text-6xl font-bold my-2 text-white animate-on-load opacity-0 translate-y-4 transition-all duration-500 ease-out delay-100">
            webfoursolutions
          </h1>
          <h2 className="text-2xl md:text-4xl font-bold my-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-600 animate-on-load opacity-0 translate-y-4 transition-all duration-500 ease-out delay-200">
            we will help you to grow your business with website
          </h2>
